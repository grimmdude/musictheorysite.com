...
the given box is contained in this one.</p>
    ...
    <span class="hljs-keyword">const</span> new_w = (<span class="hljs-keyword">this</span>.x + <span class="hljs-keyword">this</span>.w) &lt; (that.x + that.w)
      ? (that.x + that.w) - <span class="hljs-keyword">this</span>.x
      : (<span class="hljs-keyword">this</span>.x + <span class="hljs-keyword">this</span>.w) - <span class="hljs-built_in">Math</span>.min(<span class="hljs-keyword">this</span>.x, that.x);
    <span class="hljs-keyword">const</span> new_h = (<span class="hljs-keyword">this</span>.y + <span class="hljs-keyword">this</span>.h) &lt; (that.y + that.h)
      ? (that.y + that.h) - <span class="hljs-keyword">this</span>.y
      : (<span class="hljs-keyword">this</span>.y + <span class="hljs-keyword">this</span>.h) - <span class="hljs-built_in">Math</span>.min(<span class="hljs-keyword">this</span>.y, that.y);
