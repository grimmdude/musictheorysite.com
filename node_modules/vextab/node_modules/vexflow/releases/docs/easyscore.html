...
<span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Grammar</span> </span>{
  ...
  LINE() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.PIECE, <span class="hljs-keyword">this</span>.PIECES, <span class="hljs-keyword">this</span>.EOL],
    };
  }
  PIECE() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.CHORDORNOTE, <span class="hljs-keyword">this</span>.PARAMS],
      run: () =&gt; <span class="hljs-keyword">this</span>.builder.commitPiece(),
    };
  }
  PIECES() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.COMMA, <span class="hljs-keyword">this</span>.PIECE],
      zeroOrMore: <span class="hljs-literal">true</span>,
    };
  }
  PARAMS() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.DURATION, <span class="hljs-keyword">this</span>.TYPE, <span class="hljs-keyword">this</span>.DOTS, <span class="hljs-keyword">this</span>.OPTS],
    };
  }
  CHORDORNOTE() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.CHORD, <span class="hljs-keyword">this</span>.SINGLENOTE],
      or: <span class="hljs-literal">true</span>,
    };
  }
  CHORD() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.LPAREN, <span class="hljs-keyword">this</span>.NOTES, <span class="hljs-keyword">this</span>.RPAREN],
      run: (state) =&gt; <span class="hljs-keyword">this</span>.builder.addChord(state.matches[<span class="hljs-number">1</span>]),
    };
  }
  NOTES() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.NOTE],
      oneOrMore: <span class="hljs-literal">true</span>,
    };
  }
  NOTE() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.NOTENAME, <span class="hljs-keyword">this</span>.ACCIDENTAL, <span class="hljs-keyword">this</span>.OCTAVE],
    };
  }
  SINGLENOTE() {
    <span class="hljs-keyword">return</span> {
  ...
  ACCIDENTAL() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.ACCIDENTALS],
      maybe: <span class="hljs-literal">true</span>,
    };
  }
  DOTS() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.DOT],
      zeroOrMore: <span class="hljs-literal">true</span>,
      run: (state) =&gt; <span class="hljs-keyword">this</span>.builder.setNoteDots(state.matches[<span class="hljs-number">0</span>]),
    };
  }
  TYPE() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.SLASH, <span class="hljs-keyword">this</span>.MAYBESLASH, <span class="hljs-keyword">this</span>.TYPES],
      maybe: <span class="hljs-literal">true</span>,
      run: (state) =&gt; <span class="hljs-keyword">this</span>.builder.setNoteType(state.matches[<span class="hljs-number">2</span>]),
    };
  }
  DURATION() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.SLASH, <span class="hljs-keyword">this</span>.DURATIONS],
      maybe: <span class="hljs-literal">true</span>,
      run: (state) =&gt; <span class="hljs-keyword">this</span>.builder.setNoteDuration(state.matches[<span class="hljs-number">1</span>]),
    };
  }
  OPTS() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.LBRACKET, <span class="hljs-keyword">this</span>.KEYVAL, <span class="hljs-keyword">this</span>.KEYVALS, <span class="hljs-keyword">this</span>.RBRACKET],
      maybe: <span class="hljs-literal">true</span>,
    };
  }
  KEYVALS() {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.COMMA, <span class="hljs-keyword">this</span>.KEYVAL],
      zeroOrMore: <span class="hljs-literal">true</span>,
    };
  }
  KEYVAL() {
    <span class="hljs-keyword">const</span> unquote = (str) =&gt; str.slice(<span class="hljs-number">1</span>, <span class="hljs-number">-1</span>);

    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.KEY, <span class="hljs-keyword">this</span>.EQUALS, <span class="hljs-keyword">this</span>.VAL],
      run: (state) =&gt; <span class="hljs-keyword">this</span>.builder.addNoteOption(state.matches[<span class="hljs-number">0</span>], unquote(state.matches[<span class="hljs-number">2</span>])),
    };
  }
  VAL()  {
    <span class="hljs-keyword">return</span> {
      expect: [<span class="hljs-keyword">this</span>.SVAL, <span class="hljs-keyword">this</span>.DVAL],
      or: <span class="hljs-literal">true</span>,
    };
  }

  KEY()         { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'[a-zA-Z][a-zA-Z0-9]*'</span> }; }
  DVAL()        { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'["][^"]*["]'</span> }; }
  SVAL()        { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">"['][^']*[']"</span> }; }
  NOTENAME()    { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'[a-gA-G]'</span> }; }
  OCTAVE()      { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'[0-9]+'</span> }; }
  ACCIDENTALS() { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'bbs|bb|bss|bs|b|db|d|##|#|n|\\+\\+-|\\+-|\\+\\+|\\+'</span> }; }
  DURATIONS()   { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'[0-9whq]+'</span> }; }
  TYPES()       { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'[rRsSxX]'</span> }; }
  LPAREN()      { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'[(]'</span> }; }
  RPAREN()      { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'[)]'</span> }; }
  COMMA()       { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'[,]'</span> }; }
  DOT()         { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'[.]'</span> }; }
  SLASH()       { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'[/]'</span> }; }
  MAYBESLASH()  { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'[/]?'</span> }; }
  EQUALS()      { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'[=]'</span> }; }
  LBRACKET()    { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'\\['</span> }; }
  RBRACKET()    { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'\\]'</span> }; }
  EOL()         { <span class="hljs-keyword">return</span> { token: <span class="hljs-string">'$'</span> }; }
}
...
<span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Builder</span> </span>{
  ...
  reset(options = {}) {
    <span class="hljs-keyword">this</span>.options = {
      stem: <span class="hljs-string">'auto'</span>,
  ...
  resetPiece() {
    ...
    <span class="hljs-keyword">this</span>.piece = {
      chord: [],
      duration: <span class="hljs-keyword">this</span>.rollingDuration,
      dots: <span class="hljs-number">0</span>,
  ...
  commitPiece() {
    ...
    <span class="hljs-keyword">const</span> options = <span class="hljs-built_in">Object</span>.assign({}, <span class="hljs-keyword">this</span>.options, <span class="hljs-keyword">this</span>.piece.options);
    ...
    <span class="hljs-keyword">const</span> keys = chord.map(note =&gt; note.key + <span class="hljs-string">'/'</span> + note.octave);
    ...
    <span class="hljs-keyword">if</span> (!autoStem) note.setStemDirection(stemDirection);</pre></div>
        ...
        <p>Attach accidentals.</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">const</span> accids = chord.map(note =&gt; note.accid || <span class="hljs-literal">null</span>);
    accids.forEach((accid, i) =&gt; {
      <span class="hljs-keyword">if</span> (accid) note.addAccidental(i, factory.Accidental({ type: accid }));
    });</pre></div>
    ...
    <span class="hljs-keyword">this</span>.commitHooks.forEach(fn =&gt; fn(options, note, <span class="hljs-keyword">this</span>));
...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">EasyScore</span> </span>{
  <span class="hljs-keyword">constructor</span>(options = {}) {
    ...
    <span class="hljs-keyword">this</span>.defaults = {
      clef: <span class="hljs-string">'treble'</span>,
      time: <span class="hljs-string">'4/4'</span>,
      stem: <span class="hljs-string">'auto'</span>,
    };
  }
  ...
  setOptions(options) {
    <span class="hljs-keyword">this</span>.options = <span class="hljs-built_in">Object</span>.assign({
      factory: <span class="hljs-literal">null</span>,
      builder: <span class="hljs-literal">null</span>,
      commitHooks: [
        setId,
        setClass,
        Articulation.easyScoreHook,
      ],
      throwOnError: <span class="hljs-literal">false</span>,
    }, options);
    ...
    <span class="hljs-keyword">this</span>.options.commitHooks.forEach(commitHook =&gt; <span class="hljs-keyword">this</span>.addCommitHook(commitHook));
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
  }
  ...
  notes(line, options = {}) {
    options = <span class="hljs-built_in">Object</span>.assign({ clef: <span class="hljs-keyword">this</span>.defaults.clef, stem: <span class="hljs-keyword">this</span>.defaults.stem }, options);
  ...
  voice(notes, voiceOptions) {
    voiceOptions = <span class="hljs-built_in">Object</span>.assign({ time: <span class="hljs-keyword">this</span>.defaults.time }, voiceOptions);
