...
<span class="hljs-keyword">import</span> { EasyScore } <span class="hljs-keyword">from</span> <span class="hljs-string">'./easyscore'</span>;</pre></div>
...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Factory</span> </span>{
  <span class="hljs-keyword">constructor</span>(options) {
    ...
    <span class="hljs-keyword">const</span> defaults = {
      ...
      font: {
        face: <span class="hljs-string">'Arial'</span>,
        point: <span class="hljs-number">10</span>,
  ...
  <span class="hljs-keyword">static</span> newFromSelector(selector, width = <span class="hljs-number">500</span>, height = <span class="hljs-number">200</span>) {
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> Factory({ renderer: { selector, width, height } });
  }
  ...
  setOptions(options) {
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.options.renderer.selector !== <span class="hljs-literal">null</span> || <span class="hljs-keyword">this</span>.options.renderer.context) {
  ...
  initRenderer() {
    <span class="hljs-keyword">const</span> { selector, backend, width, height, background } = <span class="hljs-keyword">this</span>.options.renderer;
    ...
    <span class="hljs-keyword">this</span>.context = Renderer.buildContext(selector, backend, width, height, background);
  }
  ...
  getStave() { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.stave; }</pre></div>
  ...
  Stave(params) {
    params = setDefaults(params, {
      ...
      width: <span class="hljs-keyword">this</span>.options.renderer.width - <span class="hljs-keyword">this</span>.space(<span class="hljs-number">1</span>),
      options: {
        spacing_between_lines_px: <span class="hljs-keyword">this</span>.options.stave.space,
      },
    });
  ...
  Annotation(params) {
    params = setDefaults(params, {
      ...
      vJustify: <span class="hljs-string">'below'</span>,
      hJustify: <span class="hljs-string">'center'</span>,
      fontFamily: <span class="hljs-string">'Times'</span>,
      fontSize: <span class="hljs-number">14</span>,
      fontWeight: <span class="hljs-string">'bold italic'</span>,
      options: {},
    });
  ...
  Articulation(params) {
    params = setDefaults(params, {
      ...
      position: <span class="hljs-string">'above'</span>,
      options: {},
    });
  ...
  TextDynamics(params) {
    params = setDefaults(params, {
      text: <span class="hljs-string">'p'</span>,
      duration: <span class="hljs-string">'q'</span>,
  ...
  StaveConnector(params) {
    params = setDefaults(params, {
      top_stave: <span class="hljs-literal">null</span>,
      bottom_stave: <span class="hljs-literal">null</span>,
  ...
  Beam(params) {
    params = setDefaults(params, {
      notes: [],
      options: {
        autoStem: <span class="hljs-literal">false</span>,
      },
    });
  ...
  Curve(params) {
    params = setDefaults(params, {
      <span class="hljs-keyword">from</span>: <span class="hljs-literal">null</span>,
  ...
  StaveTie(params) {
    ...
    }, params.text).setContext(<span class="hljs-keyword">this</span>.context);
  ...
  draw() {
    <span class="hljs-keyword">this</span>.systems.forEach(i =&gt; i.setContext(<span class="hljs-keyword">this</span>.context).format());
    <span class="hljs-keyword">this</span>.staves.forEach(i =&gt; i.setContext(<span class="hljs-keyword">this</span>.context).draw());
    <span class="hljs-keyword">this</span>.voices.forEach(i =&gt; i.setContext(<span class="hljs-keyword">this</span>.context).draw());
    <span class="hljs-keyword">this</span>.renderQ.forEach(i =&gt; {
      <span class="hljs-keyword">if</span> (!i.isRendered()) i.setContext(<span class="hljs-keyword">this</span>.context).draw();
    });
    <span class="hljs-keyword">this</span>.systems.forEach(i =&gt; i.setContext(<span class="hljs-keyword">this</span>.context).draw());
    <span class="hljs-keyword">this</span>.reset();
  }
}</pre></div>
