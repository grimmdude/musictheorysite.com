...
<span class="hljs-keyword">const</span> getGlyphWidth = glyph =&gt; glyph.getMetrics().width;</pre></div>
  ...
  <span class="hljs-keyword">static</span> get CATEGORY() { <span class="hljs-keyword">return</span> <span class="hljs-string">'accidentals'</span>; }</pre></div>
    ...
    <span class="hljs-keyword">let</span> shiftL = <span class="hljs-number">0</span>;</pre></div>
        ...
        <p>First determine the accidentals’ Y positions from the note.keys</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">let</span> propsTemp;
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>; i &lt; accidentals.length; ++i) {
      ...
      <span class="hljs-keyword">if</span> (stave !== <span class="hljs-literal">null</span>) {
        ...
        <p>Sort accidentals by line number.</p>
          ...
          <div class='highlight'><pre>    accList.sort((a, b) =&gt; b.line - a.line);</pre></div>
...
stem flipping, notehead shifting concerns.</p>
    ...
    <span class="hljs-keyword">let</span> previousLine = <span class="hljs-literal">null</span>;</pre></div>
      ...
      <span class="hljs-keyword">const</span> acc = accList[i];</pre></div>
        ...
        lineList.push({
          line: acc.line,
          flatLine: <span class="hljs-literal">true</span>,
          dblSharpLine: <span class="hljs-literal">true</span>,
          numAcc: <span class="hljs-number">0</span>,
    ...
    <span class="hljs-keyword">let</span> totalColumns = <span class="hljs-number">0</span>;</pre></div>
      ...
      <span class="hljs-keyword">while</span> (groupEnd + <span class="hljs-number">1</span> &lt; lineList.length &amp;&amp; !noFurtherConflicts) {</pre></div>
        ...
        <p>Gets an a line from the <code>lineList</code>, relative to the current group</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">const</span> getGroupLine = (index) =&gt; lineList[groupStart + index];
      <span class="hljs-keyword">const</span> getGroupLines = (indexes) =&gt; indexes.map(getGroupLine);
      <span class="hljs-keyword">const</span> lineDifference = (indexA, indexB) =&gt; {
        <span class="hljs-keyword">const</span> [a, b] = getGroupLines([indexA, indexB]).map(item =&gt; item.line);
        <span class="hljs-keyword">return</span> a - b;
      };

      <span class="hljs-keyword">const</span> notColliding = (...indexPairs) =&gt;
        indexPairs
          .map(getGroupLines)
          .every(lines =&gt; !<span class="hljs-keyword">this</span>.checkCollision(...lines));</pre></div>
...
this is what keeps the columns parallel.</p>
          ...
          <div class='highlight'><pre>    lineList.forEach(line =&gt; {
...
Optionally, you can also provide an initial <code>keySignature</code>.</p>
    ...
    <span class="hljs-keyword">const</span> tickNoteMap = {};</pre></div>
        ...
        <p>Sort the tickables in each voice by their tick position in the voice</p>
          ...
          <div class='highlight'><pre>    voices.forEach(voice =&gt; {
...
applied</p>
          ...
          <div class='highlight'><pre>        note.keys.forEach((keyString, keyIndex) =&gt; {
...
example: <code>#</code>, <code>##</code>, <code>b</code>, <code>n</code>, etc.</p>
    ...
    <span class="hljs-keyword">this</span>.render_options = {</pre></div>
      ...
      parenRightPadding: <span class="hljs-number">2</span>,
    };
    ...
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.accidental) {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">'ArgumentError'</span>, <span class="hljs-string">`Unknown accidental type: <span class="hljs-subst">${type}</span>`</span>);
    }</pre></div>
    ...
    <span class="hljs-keyword">this</span>.parenLeft = <span class="hljs-literal">null</span>;
    <span class="hljs-keyword">this</span>.parenRight = <span class="hljs-literal">null</span>;

    <span class="hljs-keyword">this</span>.reset();
  }

  reset() {
    <span class="hljs-keyword">const</span> fontScale = <span class="hljs-keyword">this</span>.render_options.font_scale;
    <span class="hljs-keyword">this</span>.glyph = <span class="hljs-keyword">new</span> Glyph(<span class="hljs-keyword">this</span>.accidental.code, fontScale);
    <span class="hljs-keyword">this</span>.glyph.setOriginX(<span class="hljs-number">1.0</span>);

    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.cautionary) {
      <span class="hljs-keyword">this</span>.parenLeft = <span class="hljs-keyword">new</span> Glyph(Flow.accidentalCodes(<span class="hljs-string">'{'</span>).code, fontScale);
      <span class="hljs-keyword">this</span>.parenRight = <span class="hljs-keyword">new</span> Glyph(Flow.accidentalCodes(<span class="hljs-string">'}'</span>).code, fontScale);
      <span class="hljs-keyword">this</span>.parenLeft.setOriginX(<span class="hljs-number">1.0</span>);
      <span class="hljs-keyword">this</span>.parenRight.setOriginX(<span class="hljs-number">1.0</span>);
    }
  }

  getCategory() { <span class="hljs-keyword">return</span> Accidental.CATEGORY; }

  getWidth() {
    <span class="hljs-keyword">const</span> parenWidth = <span class="hljs-keyword">this</span>.cautionary
      ? (
        getGlyphWidth(<span class="hljs-keyword">this</span>.parenLeft) +
        getGlyphWidth(<span class="hljs-keyword">this</span>.parenRight) +
        <span class="hljs-keyword">this</span>.render_options.parenLeftPadding +
        <span class="hljs-keyword">this</span>.render_options.parenRightPadding
      )
      : <span class="hljs-number">0</span>;

    <span class="hljs-keyword">return</span> getGlyphWidth(<span class="hljs-keyword">this</span>.glyph) + parenWidth;
  }</pre></div>
    ...
    <span class="hljs-keyword">if</span> (!note) {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">'ArgumentError'</span>, <span class="hljs-string">`Bad note value: <span class="hljs-subst">${note}</span>`</span>);
    }
    ...
    <span class="hljs-keyword">if</span> (!(note &amp;&amp; (index != <span class="hljs-literal">null</span>))) {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">'NoAttachedNote'</span>, <span class="hljs-string">"Can't draw accidental without a note and index."</span>);
    }</pre></div>
        
      
        
        <p>Figure out the start <code>x</code> and <code>y</code> coordinates for note and index.</p>

        
          <div class='highlight'><pre>    <span class="hljs-keyword">const</span> start = note.getModifierStartXY(position, index);
    <span class="hljs-keyword">let</span> accX = start.x + x_shift;
    <span class="hljs-keyword">const</span> accY = start.y + y_shift;
    L(<span class="hljs-string">'Rendering: '</span>, type, accX, accY);

    <span class="hljs-keyword">if</span> (!cautionary) {
      glyph.render(context, accX, accY);
        ...
        <p>Render the accidental in parentheses.</p>
          ...
          <div class='highlight'><pre>      parenRight.render(context, accX, accY);
      accX -= getGlyphWidth(parenRight);
      accX -= parenRightPadding;
      accX -= <span class="hljs-keyword">this</span>.accidental.parenRightPaddingAdjustment;
      glyph.render(context, accX, accY);
